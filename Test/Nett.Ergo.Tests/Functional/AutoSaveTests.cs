...
namespace Nett.Coma.Tests
{
    ...
    {
        private const string FuncSaveMergedConfig = "Save Ergo Config";

        [FFact(FuncSaveMergedConfig, "When value is changed in memory, new config file gets written to disk.")]
